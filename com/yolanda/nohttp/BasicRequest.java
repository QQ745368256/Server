...
/**
 * <p>
 * Implement all the methods of the base class 实现所有基类的方法{@link IBasicRequest}.
 * </p>
...
public abstract class BasicRequest implements IBasicRequest {
    ...
    /**
     * HostnameVerifier.主机名匹配。
     */
    private HostnameVerifier mHostnameVerifier = null;
    /**
     * Connect timeout of request.连接超时的请求。
     */
    private int mConnectTimeout = NoHttp.getDefaultConnectTimeout();
    /**
     * Read data timeout.读取数据超时。
     */
    ...
    /**
     * After the failure of retries.失败后重试。
     */
    private int mRetryCount;
    /**
     * The params encoding.参数编码。
     */
     ...
     *有一个自定义请求包含物。
     * @return Returns true representatives have, return false on behalf of the no.返回true代表有,返回false代表无。
     */
    ...
    /**
     * Send binary data in a form.在一个表单发送二进制数据。
     */
